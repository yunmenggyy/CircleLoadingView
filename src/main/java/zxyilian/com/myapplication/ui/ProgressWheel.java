...
public class ProgressWheel extends View {
    ...
    private Paint mCicle = new Paint();
    ...
    private void setupPaints() {
        ...
        mCicle.setColor(ContextCompat.getColor(getContext(),android.R.color.holo_red_dark));
        mCicle.setAntiAlias(true);
        contourPaint.setStyle(Style.STROKE);
    }
